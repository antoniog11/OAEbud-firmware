...
void ir_timer_init(void){
  ...
  NRF_TIMER4->PRESCALER = 0;                                                      // Set the prescaler to 4, for a timer interval of 1 us (16M / 2^4)
  NRF_TIMER4->CC[0] = 16 * 1000 * 10;                                                   // Set the CC[0] register to hit after 0.05 seconds
